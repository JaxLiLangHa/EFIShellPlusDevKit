  ...
  )
{
  ...
  HIDString = (CHAR8*)ExtendedAcpi->HidUidCidStr;
  UIDString = (CHAR8*)NextStrA (HIDString);
  CIDString = (CHAR8*)NextStrA (UIDString);
...
struct {
  ...
  {MESSAGING_DEVICE_PATH,MSG_USB_WWID_DP,_DevPathUsbWWID},
  {MESSAGING_DEVICE_PATH,MSG_DEVICE_LOGICAL_UNIT_DP,_DevPathLogicalUnit},
  ...
  {MESSAGING_DEVICE_PATH,MSG_ISCSI_DP,_DevPathiSCSI},
  ...
  {MEDIA_DEVICE_PATH,MEDIA_FV_DP,_DevPathFvPath},
