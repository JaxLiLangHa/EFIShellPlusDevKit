...
{
  do {
    if (Width == IO_UINT8) {//EfiPciWidthUint8
      *(UINT8 *) Buffer = *(UINT8 *) (UINTN) Address;
      Address -= 1;
    } else if (Width == IO_UINT16) {//EfiPciWidthUint16
      *(UINT16 *) Buffer = *(UINT16 *) (UINTN) Address;
      Address -= 2;
    } else if (Width == IO_UINT32) {//EfiPciWidthUint32
      *(UINT32 *) Buffer = *(UINT32 *) (UINTN) Address;
      Address -= 4;
    } else if (Width == IO_UINT64) {//EfiPciWidthUint64
